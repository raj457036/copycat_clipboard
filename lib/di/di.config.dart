...
import '../bloc/clip_collection_cubit/clip_collection_cubit.dart' as _i31;
...
import '../bloc/sync_manager_cubit/sync_manager_cubit.dart' as _i30;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i18.AuthCubit>(
        () => _i18.AuthCubit(gh<_i19.SupabaseClient>()));
    gh.lazySingleton<_i11.ClipCollectionSource>(
      () => _i20.RemoteClipCollectionSource(gh<_i14.SupabaseClient>()),
      instanceName: 'remote',
    );
    gh.lazySingleton<_i21.OfflinePersistanceCubit>(
        () => _i21.OfflinePersistanceCubit(
              gh<_i18.AuthCubit>(),
    ...
    gh.factory<_i22.ClipboardCubit>(() => _i22.ClipboardCubit(
          gh<_i15.ClipboardRepository>(instanceName: 'offline'),
          gh<_i4.Isar>(),
        ));
    gh.lazySingleton<_i23.DriveCredentialRepository>(
        () => _i23.DriveCredentialRepositoryImpl(gh<_i19.SupabaseClient>()));
    gh.lazySingleton<_i15.ClipboardRepository>(
    ...
    gh.lazySingleton<_i25.DriveSetupCubit>(
        () => _i25.DriveSetupCubit(gh<_i23.DriveCredentialRepository>()));
    ...
    gh.singleton<_i30.SyncManagerCubit>(() => _i30.SyncManagerCubit(
          gh<_i4.Isar>(),
          gh<_i18.AuthCubit>(),
