...
import '../bloc/collection_clips_cubit/collection_clips_cubit.dart' as _i32;
import '../bloc/drive_setup_cubit/drive_setup_cubit.dart' as _i30;
...
import '../data/repositories/clip_collection.dart' as _i31;
import '../data/repositories/clipboard.dart' as _i18;
import '../data/repositories/drive_credential.dart' as _i26;
import '../data/repositories/subscription.dart' as _i29;
...
import '../db/clip_collection/clipcollection.dart' as _i33;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i22.AuthCubit>(
        () => _i22.AuthCubit(gh<_i17.SupabaseClient>()));
    gh.lazySingleton<_i14.ClipCollectionSource>(
    ...
    gh.factory<_i28.SearchCubit>(() => _i28.SearchCubit(
        gh<_i18.ClipboardRepository>(instanceName: 'offline')));
    gh.lazySingleton<_i29.SubscriptionRepository>(
    ...
    gh.lazySingleton<_i30.DriveSetupCubit>(
        () => _i30.DriveSetupCubit(gh<_i26.DriveCredentialRepository>()));
    gh.lazySingleton<_i31.ClipCollectionRepository>(
        () => _i31.ClipCollectionRepositoryImpl(
              gh<_i14.ClipCollectionSource>(instanceName: 'remote'),
              gh<_i14.ClipCollectionSource>(instanceName: 'local'),
            ));
    gh.factoryParam<_i32.CollectionClipsCubit, _i33.ClipCollection, dynamic>((
      collection,
      _,
    ) =>
        _i32.CollectionClipsCubit(
          gh<_i18.ClipboardRepository>(instanceName: 'offline'),
          collection: collection,
        ));
    gh.singleton<_i34.MonetizationCubit>(
        () => _i34.MonetizationCubit(gh<_i29.SubscriptionRepository>()));
    gh.singleton<_i35.SyncManagerCubit>(() => _i35.SyncManagerCubit(
          gh<_i6.Isar>(),
          gh<_i22.AuthCubit>(),
          gh<_i19.SyncRepository>(),
          gh<_i31.ClipCollectionRepository>(),
          gh<String>(instanceName: 'device_id'),
        ));
    gh.lazySingleton<_i36.CloudPersistanceCubit>(
        () => _i36.CloudPersistanceCubit(
              gh<_i22.AuthCubit>(),
              gh<_i30.DriveSetupCubit>(),
              gh<_i16.AppConfigCubit>(),
              gh<String>(instanceName: 'device_id'),
