...
class CopyCatSharedStorage(applicationContext: Context) {
    ...
    private var _excludedPackages: Set<String> = emptySet()
    ...
    private fun readConfig() {
        ...
        _excludedPackages = sp.getStringSet("excludedPackages", emptySet())!!
